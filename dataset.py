...
class GANDataModule( LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if os.name == 'nt':
            ...
            self.train_path = 'dataset_file/Load_AR_training_50_0_P.txt'
            self.valid_path = 'dataset_file/Load_AR_test_50_0.txt'
            self.test_path = 'dataset_file/Load_AR_test_50_0.txt'
